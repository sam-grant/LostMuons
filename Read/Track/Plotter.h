...
public:
  ...
  void InitHistos();
  void plot1D(TString name, int nbins, float xlow, float xhigh, TString xtitle="x axis", TString ytitle="", int col=9);  
  TH1* plot1DMaker(TString name, int nbins, float xlow, float xhigh, TString xtitle="x axis", TString ytitle="", int col=9);  
  TH2* plot2DMaker(TString name, int nbinsx, float xlow, float xhigh, int nbinsy, float ylow, float yhigh, TString xtitle="x axis", TString ytitle="", int col=9);  
  void Fill1D(TString name, double val, double weight=1);
  void plot2D(TString name, int xnbins, float xlow, float xhigh, int ynbins, float ylow, float yhigh, TString xtitle="x axis", TString ytitle="", int col=9);
  void Fill2D(TString name, double xval, double yval, double weight=1);

  void plot1DTr(TString name, int nbins, float xlow, float xhigh, TString xtitle="x axis", TString ytitle="", int col=9);  
  void Fill1DTr(TString name, double val, double weight=1);
  void plot2DTr(TString name, int xnbins, float xlow, float xhigh, int ynbins, float ylow, float yhigh, TString xtitle="x axis", TString ytitle="", int col=9);
...
int main(int argc, char *argv[]){
  ...
  if (argc < 2){
    ...
    fileNames.push_back("../../../Ntuples/60hr_v9_17_01/gm2rootTrees_ana_15922.root");
  }
