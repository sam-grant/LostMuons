//Code to overlay EoP mom plots for tracker & calo with high energy cut 
...
int main() {
  ...
  TFile *f1 = TFile::Open("../cluster_shoulder/merged_shoulder.root");

  string fname1 = "../plots/stn"+to_string(stn)+"_Eop_shoulder.png";
  string fname2 = "../plots/stn"+to_string(stn)+"_Eop_n_shoulder.png";
  string fname3 = "../plots/stn"+to_string(stn)+"_Eop_mu_shoulder.png";
