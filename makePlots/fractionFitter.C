...
int main() {
  ...
  string h1 = "St"+to_string(stn)+"_mom";
  string h2 = "St"+to_string(stn)+"_n_mom";
  string h3 = "St"+to_string(stn)+"_mu_mom";
  
  /*
  string h1 = "St"+to_string(stn)+"_mom_0";
  string h2 = "St"+to_string(stn)+"_n_mom_dtdR_0";
  string h3 = "St"+to_string(stn)+"_mu_mom_dtdR_0";
  */
  
  string fname1 = "../plots/fracFit_"+to_string(stn)+"_dtdR.pdf";
  string fname2 = "../plots/momRatio_"+to_string(stn)+"_dtdR.pdf";
  ...
  */
  string title1 = "Stn "+to_string(stn)+" | Fractional Fit: 2300 MeV - 3000 MeV; Momentum [MeV]; Number of Hits";
  string title2 = "Stn "+to_string(stn)+" | Fractional Fit Region;Momentum [MeV];Number of Hits";
