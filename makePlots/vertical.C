...
int main() {
  ...
  string h1 = "St"+to_string(stn)+"_y_track";
  string h2 = "St"+to_string(stn)+"_mu_y_track";
  string h3 = "St"+to_string(stn)+"_n_y_track";

  string fname1;
  if (s == 0 ) {
    fname1 = "../plots/stn"+to_string(stn)+"_tracker_vertical_subtracted.pdf";
  }
  if ( s == 1 ) { 
    fname1 = "../plots/stn"+to_string(stn)+"_tracker_vertical_subtracted_noscale.pdf";
  }


  string title1 = "Stn "+to_string(stn)+" | Vertical Decay Vertices;Vertical Decay Vertex [mm];Number of Hits";
