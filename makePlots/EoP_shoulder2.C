...
int main() {
  ...
  string fname1 = "../plots/stn"+to_string(stn)+"_Eop_shoulder2.png";
  string fname2 = "../plots/stn"+to_string(stn)+"_Eop_n_shoulder2.png";
  string fname3 = "../plots/stn"+to_string(stn)+"_Eop_mu_shoulder2.png";
