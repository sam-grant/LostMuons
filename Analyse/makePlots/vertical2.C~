...
int main() {
  ...
  // Hard code  scale factors
    if ( stn == 12 ) {
      sfMu =  2.75606;//1.46936; // +/- 0.0533611 //1.43700046271415;
    }
    else if ( stn == 18 ) {
      sfMu =1.72981 ;// 1.56875; //+/- 0.0385335 //1.56875;//1.59170023827753;
    }
  
 
    string h1 = "St"+to_string(stn)+"_vertical";
    string h2 = "St"+to_string(stn)+"_vertical_2";

    string fname1;
    // string fname2 = "../plots/stn"+to_string(stn)+"_tracker_radius_check.pdf";

    if (scale) {
      fname1 = "../plots/stn"+to_string(stn)+"_tracker_vertical_subtracted_60.png";
    }
    else if (!scale) { 
      fname1 = "../plots/stn"+to_string(stn)+"_tracker_vertical_subtracted_noscale_60.png";
    }

    string title1 = "Stn "+to_string(stn)+" | Vertical Decay Vertices;Vertical Decay Vertex [mm];N";
    ...
    */
    ...
    v->GetXaxis()->SetRangeUser(-60,60);
    mu->GetXaxis()->SetRangeUser(-60,60);
    subMu->GetXaxis()->SetRangeUser(-60,60);
