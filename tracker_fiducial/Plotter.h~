...
void Plotter::plot1DTr(TString name, int nbins, float xlow, float xhigh, TString xtitle, TString ytitle, int col){
  ...
  // plot1D("St13_"+name, nbins, xlow, xhigh, xtitle, ytitle, col);
  // plot1D("St19_"+name, nbins, xlow, xhigh, xtitle, ytitle, col);
}
...
void Plotter::plot2DTr(TString name, int xnbins, float xlow, float xhigh, int ynbins, float ylow, float yhigh, TString xtitle, TString ytitle, int col){
  // CHANGE ACCORDINGLY
   ...
   // plot2D("St13_"+name, xnbins, xlow, xhigh, ynbins, ylow, yhigh, xtitle, ytitle, col);
   //plot2D("St19_"+name, xnbins, xlow, xhigh, ynbins, ylow, yhigh, xtitle, ytitle, col);
}  
...
int main(int argc, char *argv[]){
  ...
  if (argc < 2){
    ...
    //  fileNames.push_back("/unix/atlasgenerators/hesketh/Omega/gm2rootTrees_ana_15922.root");
    //fileNames.push_back("/scratch/folders/junk/gm2rootTrees_ana.root");
    fileNames.push_back("/unix/muons/g-2/omegaEU/60hr_v9_11_00/gm2rootTrees_ana_15922.root");
  }
