...
int main() {
  ...
  for (int stn = 12 ; stn<19 ; stn = stn + 6) {
    ...
    string h1 = "St"+to_string(stn)+"_radial60";
    string h2 = "St"+to_string(stn)+"_radial60_2";
    ...
    TFile *f1 = TFile::Open("../OldRootFiles/merged_tracker_combined.root"); //ReadNewNTuples/Track/RootFiles/Track.root");
    TFile *f2 = TFile::Open("../OldRootFiles/merged_cluster_combine.root");//ReadNewNTuples/TrackCluster/RootFiles/TrackCluster.root");
