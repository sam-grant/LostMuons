 ...
 bool combine = false; 
  ...
  // Hard code  scale factors
    if (combine) {
      sfMu = 2.09796;
      h1 =  "radial60"; // tracker
      h2 = "radial60_2"; // cluster lost muons
      title1 = "Both Stations | Radial Decay Vertices;Radial Decay Vertex [mm];N";
      
      if (scale) {
	fname1 = "../plots/tracker_radial60_subtracted.png";
      }
      else if (!scale) { 
	fname1 = "../plots/tracker_radial60_subtracted_noscale.png";
      }	
    }
      ...
      h1 =  "St18_radial60"; // tracker
      h2 = "St18_radial60_2"; // cluster lost muons
      
       title1 = "Stn 18 | Radial Decay Vertices;Radial Decay Vertex [mm];N";
     
      if (scale) {
	fname1 = "../plots/stn18_tracker_radial60_subtracted.png";
      }
      else if (!scale) { 
	fname1 = "../plots/stn18_tracker_radial60_subtracted_noscale.png";
      }
    ...
    */
    ...
    v->GetYaxis()->SetRangeUser(1,1e6);//(kBlue+2);
    //->SetLineColor(kBlue+2);
    ...
    ratio->SetName("All Tracks / Non Lost Muons");
    ...
    //ratio->GetXaxis()->SetRangeUser(-60,60);
    gPad->SetGrid();
    ratio->Draw();
    // tps3->Draw("same");  
