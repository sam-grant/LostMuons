...
int main() {
  ...
  string fname1 = "../plots/stn"+to_string(stn)+"_Eop_master.png";
  string fname2 = "../plots/stn"+to_string(stn)+"_Eop_n_master.png";
  string fname3 = "../plots/stn"+to_string(stn)+"_Eop_mu_master.png";
